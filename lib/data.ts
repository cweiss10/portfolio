...
export const projects: Project[] = [
  ...
  {
    title: "Project Two",
    description: "An AI-powered analytics dashboard that visualizes complex data sets and provides actionable insights for businesses.",
    technologies: ["Next.js", "Python", "TensorFlow", "Chart.js"],
    githubUrl: "https://github.com/yourusername/project-two",
  },
  {
    title: "Project Three",
    description: "A mobile-first e-commerce platform with seamless checkout experience and inventory management system.",
  ...
  {
    title: "Project Four",
    description: "Open-source developer tool that automates deployment workflows and integrates with popular CI/CD platforms.",
